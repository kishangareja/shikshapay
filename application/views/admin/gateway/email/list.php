            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                        <?=$page;?> <a href="javascript:;" onclick="popup_add_mgateway(0);" class="pull-right btn m-b-xs btn-sm btn-primary btn-addon">
                            <i class="fa fa-plus"></i>Add Email Gateway</a>
                ...
                <div class="table-responsive">
                    ...
                    <input type="hidden" id="ajax_list_url" value="<?= base_url('admin/gateway/ajax_emaillist'); ?>">
                </div>
            </div>
        </div>
...
<script>
    function popup_add_mgateway(id) {
        $.ajax({
            url: "<?=base_url('admin/gateway/ajax_add_egateway');?>",
            data: {gateway_id: id},
            type: 'post',
            dataType: 'json',
    ...
    function add_mgateway() {
        $.ajax({
            url: '<?=base_url('admin/gateway/emailedit');?>',
            type: 'POST',
