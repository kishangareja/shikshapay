        ...
        <div class="wrapper-md">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <?=$page;?> <a href="<?=base_url('admin/notice/add_event');?>" class="pull-right btn m-b-xs btn-sm btn-primary btn-addon">
...
if ($notice_data) {
	...
	foreach ($notice_data as $key => $value) {
		?>
                                ...
                                <td><a class="btn btn-primary" href="<?php echo base_url('admin/notice/event_detail/') . $value->id ?>">view</a></td>
