                    ...
                    <form class="form-horizontal" method="post" action="">
                            ...
                            <div class="col-md-4">
                                <select name="institution_id[]" class="form-control w-md" id="set_institution" multiple="true">
                                    ...
                                    <?php foreach ($institution_data as $value) { ?>
                                        ...
                                        if (isset($student_data->institution_id) && $value->id == $student_data->institution_id) {
                                            echo "selected";
                                        }
                                        ?>><?php echo $value->institution_name; ?></option>
                                            <?php } ?>
                                </select>
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-5">
                                ...
                                <a href="<?php echo base_url('admin/notice/event') ?>" class="btn btn-default">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
