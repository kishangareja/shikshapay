                                ...
                                <div class="panel-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group <?= ((form_error('register_no') != "") ? "has-error" : ""); ?>">
                                                ...
                                                <input name="register_no" id="register_no" type="text" class="form-control" placeholder="Enter Reg No"
                                                       value="<?= isset($additional_fee->admission_no) && $additional_fee->admission_no ? $additional_fee->admission_no : set_value('register_no'); ?>">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="checkbox">
                                                    <label class="i-checks">     
                                                        <input type="checkbox" name="all_month" data-required="1" id="all_month"
                                                               value="1" <?= isset($additional_fee->all_month) && $additional_fee->all_month ? 'checked="checked"' : ''; ?>/> 
                                                        <i></i>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <?php /*
                                          ...
                                          <input type="text" name="additional_fee" id="additional_fee" class="form-control"
                                          value="<?= isset($additional_fee) && $additional_fee->additional_fee ? $additional_fee->additional_fee : ''; ?>">
                                          </div>
                                          </div>
                                         */ ?>                                        
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="concession_type" class="form-control" id="concession_type">
                                                    <option value="percentage" <?= (isset($additional_fee) && $additional_fee->concession_type == 'percentage') ? 'selected="selected"' : ''; ?>>Percentage</option>
                                                    <option value="rupee" <?= (isset($additional_fee) && $additional_fee->concession_type == 'rupee') ? 'selected="selected"' : ''; ?>>Rupee</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="status" class="form-control" id="status">
                                                    <option value="1" <?= (isset($additional_fee) && $additional_fee->status == 1) ? 'selected="selected"' : ''; ?>>Active</option>
                                                    <option value="0" <?= (isset($additional_fee) && $additional_fee->status == 0) ? 'selected="selected"' : ''; ?>>In active</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="hidden" id="class_id" name="class_id" value="<?= isset($additional_fee->class_id) && $additional_fee->class_id ? $additional_fee->class_id : ''; ?>">
